...
//{
//	CFaultFormation faultFormation;
//	faultFormation.SetSize(glm::vec2(w, h));
//	faultFormation.SetIterations(countItr);
//	faultFormation.SetDelta(delta);
//	faultFormation.CreateTexture();
//	return faultFormation.GetTexture();
//
